...
#ifndef XTENSOR_PYTHON_PYBIND11_PYVECTORIZE_HPP
#define XTENSOR_PYTHON_PYBIND11_PYVECTORIZE_HPP
...
namespace xt
{
    namespace pybind11
    {
        ...
        template <class F>
        inline auto pyvectorize(F&& f) -> decltype(::xt::pybind11::pyvectorize(std::forward<F>(f), (::xt::detail::get_function_type<F>*)nullptr))
        {
            return ::xt::pybind11::pyvectorize(std::forward<F>(f), (::xt::detail::get_function_type<F>*)nullptr);
        }
        /// @endcond
