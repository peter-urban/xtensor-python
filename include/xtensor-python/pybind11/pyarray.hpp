...
#ifndef XTENSOR_PYTHON_PYBIND11_PYARRAY_HPP
#define XTENSOR_PYTHON_PYBIND11_PYARRAY_HPP
...
#include "../detail/pyarray_backstrides.hpp"
#include "pycontainer.hpp"
#include "../detail/pystrides_adaptor.hpp"
...
namespace pybind11
{
    namespace detail
    {
        ...
        struct handle_type_name<xt::pybind11::pyarray<T, L>>
        {
        ...
        struct pyobject_caster<xt::pybind11::pyarray<T, L>>
        {
            using type = xt::pybind11::pyarray<T, L>;
        ...
        template <typename T, xt::layout_type L>
        struct type_caster<xt::xexpression<xt::pybind11::pyarray<T, L>>> : pyobject_caster<xt::pybind11::pyarray<T, L>>
        {
            using Type = xt::xexpression<xt::pybind11::pyarray<T, L>>;
...
namespace xt
{
    ...
    struct xiterable_inner_types<pybind11::pyarray<T, L>>
        : xcontainer_iterable_types<pybind11::pyarray<T, L>>
    {
    };

    template <class T, layout_type L>
    struct xcontainer_inner_types<pybind11::pyarray<T, L>>
    {
    ...
    namespace pybind11
    {
            ...
            : base_type()
        {
            ...
            xt::detail::default_initialize(m_storage);
        }
