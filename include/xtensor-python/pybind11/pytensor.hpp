...
#ifndef XTENSOR_PYTHON_PYBIND11_PYTENSOR_HPP
#define XTENSOR_PYTHON_PYBIND11_PYTENSOR_HPP
...
namespace pybind11
{
    namespace detail
    {
        ...
        struct handle_type_name<xt::pybind11::pytensor<T, N, L>>
        {
        ...
        template <class T, std::size_t N, xt::layout_type L>
        struct pyobject_caster<xt::pybind11::pytensor<T, N, L>>
        {
            using type = xt::pybind11::pytensor<T, N, L>;
        ...
        template <class T, std::size_t N, xt::layout_type L>
        struct type_caster<xt::xexpression<xt::pybind11::pytensor<T, N, L>>> : pyobject_caster<xt::pybind11::pytensor<T, N, L>>
        {
            using Type = xt::xexpression<xt::pybind11::pytensor<T, N, L>>;
...
namespace xt
{
    ...
    struct xiterable_inner_types<pybind11::pytensor<T, N, L>>
        : xcontainer_iterable_types<pybind11::pytensor<T, N, L>>
    {
    };

    template <class T, std::size_t N, layout_type L>
    struct xcontainer_inner_types<pybind11::pytensor<T, N, L>>
    {
        ...
        using temporary_type = pybind11::pytensor<T, N, L>;
    ...
    namespace pybind11
    {
        ...
        {
            xt::detail::check_dims<shape_type>::run(shape.size());
